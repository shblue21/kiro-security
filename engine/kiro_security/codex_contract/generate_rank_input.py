...
# upstream relative path: scripts/generate_rank_input.py
# upstream sha256: 625913be1fa1339de94b3f891cd6b6b420e0a5913dc473e0f8964728a82a78e3
...
#!/usr/bin/env python3
"""Generate and post-process Kiro Security Power scan worklists.
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Kiro Security Power scan worklist helper.")
    ...
    pool_plan.add_argument(
        ...
        required=True,
        type=int,
        help="Usable ranking-worker slots reported by capability preflight; capped at 4.",
    )
