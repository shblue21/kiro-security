...
# upstream relative path: scripts/report_projection.py
# upstream sha256: 0e6c246ac0a7c63bb3e8801ca87cddc5c26a1d6898e0e0591f2e94a0483ec4c7
...
#!/usr/bin/env python3
"""Project canonical Kiro Security Power scan JSON into the standard reports."""
...
def _load_script(name: str) -> ModuleType:
    ...
    spec = importlib.util.spec_from_file_location(f"kiro_security_{name}", path)
