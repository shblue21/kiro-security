...
# upstream relative path: scripts/validate_report_format.py
# upstream sha256: 653703cee503cb1a2a69b84dab1d6d984253bd1a779838dc5720ea67d4972b0c
# allowed Kiro changes: package-local import path only.
# prohibited semantic changes: none; keep the upstream algorithm and contract intact.

#!/usr/bin/env python3
"""Validate the shared Kiro Security Power final report shape."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Validate the Kiro Security Power report format.")
